 ...
 * 제품의 매장 내 위치를 나타냄
 */
export default function LocationIcon({ size = 24, className = '' }: IconProps) {
    return (
        <svg
            width={size}
            height={size * 1.59} // 원본 비율 유지 (27:43)
            viewBox="0 0 27 43"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className={className}
        >
            <g clipPath="url(#clip0_202_1522)">
                <g filter="url(#filter0_f_202_1522)">
                    <ellipse cx="13.5" cy="39.5" rx="4.5" ry="2.5" fill="black" fillOpacity="0.12" />
                </g>
                <mask id="path-2-outside-1_202_1522" maskUnits="userSpaceOnUse" x="0" y="0" width="27" height="40" fill="black">
