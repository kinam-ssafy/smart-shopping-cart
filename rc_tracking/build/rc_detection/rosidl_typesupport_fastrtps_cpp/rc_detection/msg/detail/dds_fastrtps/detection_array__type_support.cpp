...
#include "rc_detection/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rc_detection::msg::Detection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rc_detection::msg::Detection &);
size_t get_serialized_size(
  const rc_detection::msg::Detection &,
  size_t current_alignment);
size_t
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      rc_detection::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  rc_detection::msg::DetectionArray & ros_message)
{
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      rc_detection::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rc_detection::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rc_detection::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = rc_detection::msg::DetectionArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rc_detection::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rc_detection::msg::DetectionArray *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_rc_detection
const rosidl_message_type_support_t *
get_message_type_support_handle<rc_detection::msg::DetectionArray>()
{
  return &rc_detection::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
