...
#include "rc_detection/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rc_detection::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rc_detection::msg::Detection & ros_message)
{
  // Member: track_id
  cdr >> ros_message.track_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rc_detection::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rc_detection::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rc_detection::msg::Detection *>(
    untyped_ros_message);
...
{
  return &rc_detection::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rc_detection, msg, Detection)() {
  return &rc_detection::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
