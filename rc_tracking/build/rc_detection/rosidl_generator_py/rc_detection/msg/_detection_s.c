...
bool rc_detection__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rc_detection.msg._detection.Detection", full_classname_dest, 37) == 0);
  }
  rc_detection__msg__Detection * ros_message = _ros_message;
  {  // track_id
...
PyObject * rc_detection__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rc_detection.msg._detection");
