...
class Metaclass_DetectionArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('rc_detection')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'rc_detection.msg.DetectionArray')
            logger.debug(
            ...
            from rc_detection.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<rc_detection/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rc_detection', 'msg'], 'Detection')),  # noqa: E501
    )
